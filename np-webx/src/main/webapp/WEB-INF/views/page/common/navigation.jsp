                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <%-- <div class="navbar-brand">--%>
                            ...
                            <%-- <c:if test="${user==null }">--%>
                                <%-- <a href="/login" title="登陆" class="mainhead-avatar avatar centre" height="40"
                                    width="40">--%>
                                            ...
                                            <%-- </a>--%>
                                                <%-- </c:if>--%>
                                                    <%-- <c:if test="${user!=null }">--%>
                                                        ...
                                                        <%-- <a href="/cm/channel" title="个人中心"
                                                            class="mainhead-avatar avatar centre" height="40"
                                                            width="40">--%>
                                                            <%-- <c:if test="${user.headPath==null }">--%>
                                                                <%-- <span class="max-width-50  ${user.headSpanClass }"
                                                                    alt="${user.username}" height="40" --%>
                                                                    <%-- width="40">${user.headSpan }</span>--%>
                                                                        <%-- </c:if>--%>
                                                                            <%-- <c:if
                                                                                test="${user.headPath!=null }">--%>
                                                                                <%-- <img src="/bruce${user.headPath}"
                                                                                    alt="davatar"
                                                                                    class="img-circle max-width-50"
                                                                                    height="40" --%>
                                                                                    <%-- width="40" />--%>
                                                                                    <%-- </c:if>--%>
                                                                                        <%-- </a>--%>
                                                                                            ...
                                                                                            <%-- </c:if>--%>
                                                                                                ...
                                                                                                <%-- <a
                                                                                                    ...
                                                                                                    <%-- <span
                                                                                                        ...
                                                                                                        <%-- <a href="/"
                                                                                                            title="首页"
                                                                                                            class="btn-xs margin-l10">--%>
                                                                                                            <%-- <span
                                                                                                                class="fa fa-home fa-lg padding5"></span></a>--%>
                    ...
                    <div class="navbar-collapse collapse mainhead-collapse">
                        <ul class="nav mainhead-nav" id="J_tabs">
                            ...
                            <%-- <li cname="soft"><a href="/soft/mac" title="丰富的Mac软件资源"><i
                                        class="fa fa-music padding5"></i>音乐</a></li>--%>
                                    ...
                                    <c:if test="${user!=null }">
                                        <div class="user-avatar-dropdown dropdown">
                                            <a class="dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown"
                                                ...
                                                <c:choose>
                                                    <c:when test="${not empty user.headPath}">
                                                        <img src="/bruce${user.headPath}" alt="${user.username}"
                                                            class="avatar-image img-circle max-width-50" />
                                                    </c:when>
                                                    ...
                                                    <c:otherwise>
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                                <!-- 为中文字符等使用哈希算法分配颜色 -->
                                                                <c:set var="charCode"
                                                                    value="${firstChar.hashCode() % 12}" />
                                                                <c:choose>
                                                                    <c:when test="${charCode == 0 || charCode == -12}">
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-1" />
                                                                    </c:when>
                                                                    <c:when test="${charCode == 1 || charCode == -11}">
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-2" />
                                                                    </c:when>
                                                                    <c:when test="${charCode == 2 || charCode == -10}">
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-3" />
                                                                    </c:when>
                                                                    <c:when test="${charCode == 3 || charCode == -9}">
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-4" />
                                                                    </c:when>
                                                                    <c:when test="${charCode == 4 || charCode == -8}">
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-5" />
                                                                    </c:when>
                                                                    <c:when test="${charCode == 5 || charCode == -7}">
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-6" />
                                                                    </c:when>
                                                                    <c:when test="${charCode == 6 || charCode == -6}">
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-7" />
                                                                    </c:when>
                                                                    <c:when test="${charCode == 7 || charCode == -5}">
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-8" />
                                                                    </c:when>
                                                                    <c:when test="${charCode == 8 || charCode == -4}">
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-9" />
                                                                    </c:when>
                                                                    <c:when test="${charCode == 9 || charCode == -3}">
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-10" />
                                                                    </c:when>
                                                                    <c:when test="${charCode == 10 || charCode == -2}">
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-11" />
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <c:set var="colorClass"
                                                                            value="avatar-color-12" />
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </c:otherwise>
                                                        </c:choose>
                                                        <span
                                                            class="user-avatar-letter ${colorClass}">${firstChar}</span>
                                                    </c:otherwise>
                                                </c:choose>
                                            </a>
                                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                                ...
                                                <li role="presentation">
                                                    <a role="menuitem" tabindex="-1" href="/cm/channel"
                                                        title="${user.username}的个人空间">
