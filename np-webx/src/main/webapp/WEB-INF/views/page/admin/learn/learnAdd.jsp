                        ...
                        <div class="clearfix maincontent">
                                <div class="container">
                                        <div class="mainbody" style="margin-top: 5em;">
                                                <div
                                                        class="align-center bg-white radius-5 padding10 max-width-700 min-width-300">
                                                        <form method="POST" action="/learning/addItem"
                                                                accept-charset="UTF-8" role="form" id="addItemForm"
                                                                style="color: #444;" class="form margin-t20"
                                                                ...
                                                                <div class="form-group ">
                                                                        <span
                                                                                class="glyphicon glyphicon-star"></span>下载地址
                                                                        <div id="J_path_editor" style="height: 200px;">
                                                                        </div>
                                                                        <textarea id="J_path" name="path"
                                                                                style="display: none;">${model.path }</textarea>
                                                                </div>
                                                                <div class="form-group ">
                                                                        <span
                                                                                class="glyphicon glyphicon-star"></span>学习颜色
                                                                ...
                                                                <div class="form-group ">
                                                                        <span
                                                                                class="glyphicon glyphicon-star"></span>学习标签
                                                                        <input id="J_tag" placeholder="学习标签" required
                                                                                class="form-control  input-lg  border-light-1 bg-lyellow grid98 radius-0"
                                                                                name="tags" type="text"
                                                                                value="${model.tags },课程分享">
                                                                </div>
                                                                <div class="form-group ">
                                                                        <span
                                                                                class="glyphicon glyphicon-star"></span>学习标签-英文
                                                                        <input id="J_tag_code" placeholder="学习标签-英文"
                                                                                required
                                                                                class="form-control  input-lg  border-light-1 bg-lyellow grid98 radius-0"
                                                                                name="tagsCode" type="text"
                                                                                value="${model.tagsCode },classhare">
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                        <span
                                                                                class="glyphicon glyphicon-star"></span>学习预览
                                                                        <div id="J_md_brief_editor"
                                                                                style="height: 200px;"></div>
                                                                        <textarea id="J_md_brief" name="brief"
                                                                                style="display: none;"><c:out value="${model.brief }" escapeXml="true"></c:out><c:if test="${model.brief ==null}">—/马哥/0000000000000马哥Linux高端运维云计算就业班-教学总监老王主讲/
...
├──11-01-软件管理基础.mp4 216.81M</c:if></textarea>
                                                                ...
                                                                <div class="form-group">
                                                                        <span
                                                                                class="glyphicon glyphicon-star"></span>学习内容
                                                                        <div id="J_md_text_editor"
                                                                                style="height: 200px;"></div>
                                                                        <textarea id="J_md_text" name="content"
                                                                                style="display: none;"><c:out value="${model.content }" escapeXml="true"></c:out><c:if test="${model.content ==null}">—/马哥/0000000000000马哥Linux高端运维云计算就业班-教学总监老王主讲/
├──1-01-课程架构介绍和计算机基础.mp4 147.51M
├──1-02-计算机硬件组成.mp4 341.69M
├──1-03-操作系统基础.mp4 205.91M
├──1-04-Linux介绍.mp4 361.36M
...
├──11-01-软件管理基础.mp4 216.81M</c:if></textarea>
                                                                ...
                                                                <div class="form-group">
                                                                        <input id="formSubmit" data-activetext="添加 ››"
                                                                                class="btn btn-hero btn-xlg margin-t10 grid50"
                        ...
                        <%@ include file="/WEB-INF/views/page/common/container.jsp" %>
                                ...
                                <script type="text/javascript">
                                        // 声明全局变量
                                        var contentEditor, pathEditor, briefEditor;
                                        ...
                                        $(function () {
                                                ...
                                                // 初始化学习内容编辑器
                                                contentEditor = new Quill('#J_md_text_editor', {
                                                        theme: 'snow',
                                                        modules: {
                                                ...
                                                // 初始化下载地址编辑器
                                                pathEditor = new Quill('#J_path_editor', {
                                                        theme: 'snow',
                                                        modules: {
                                                                toolbar: toolbarOptions
                                                        }
                                                ...
                                                // 初始化学习预览编辑器
                                                briefEditor = new Quill('#J_md_brief_editor', {
                                                        theme: 'snow',
                                                        modules: {
                                                                toolbar: toolbarOptions
                                                        }
